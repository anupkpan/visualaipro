...
export default function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post('/api/nlp-parser', { question });
  ...
  const handleGenerateOutput = async () => {
    ...
    try {
      const response = await axios.post('/api/generate-final', { prompt });
  ...
  return (
    <div style={{ fontFamily: 'Inter, sans-serif', padding: '20px', maxWidth: '700px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '1.8rem', margin: 0 }}>Visual AI Pro</h1>
